  ...
  return (
    <aside className="flex h-screen w-64 flex-col border-r border-border bg-card">
      <div className="flex h-16 items-center gap-2 border-b border-border px-6">
        ...
        <span className="text-lg font-bold text-primary">VRMM</span>
      </div>
      ...
      <div className="border-t border-border p-3">
        <button
          ...
          className="flex w-full items-center gap-3 rounded px-3 py-2.5 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
        >
